    ...
    return (
      <div className="space-y-8 animate-pulse">
        ...
        <div className="space-y-2">
          <div className="h-8 w-60 bg-crm-cardHover/60 rounded-lg" />
          <div className="h-4 w-96 bg-crm-cardHover/40 rounded-lg" />
        </div>
        
        {/* KPI Skeleton Grid */}
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="glass-panel h-32 rounded-xl p-6 bg-crm-cardHover/20 border border-crm-border/10 flex flex-col justify-between">
              <div className="flex justify-between items-center">
                <div className="h-3 w-24 bg-crm-cardHover/40 rounded" />
                <div className="h-8 w-8 bg-crm-cardHover/50 rounded-lg" />
              </div>
              <div className="h-6 w-20 bg-crm-cardHover/60 rounded mt-4" />
            </div>
          ))}
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="glass-panel h-80 rounded-xl p-6 lg:col-span-2 bg-crm-cardHover/20 border border-crm-border/10 flex flex-col justify-between">
            <div className="space-y-1">
              <div className="h-4 w-32 bg-crm-cardHover/50 rounded" />
              <div className="h-3 w-48 bg-crm-cardHover/30 rounded" />
            </div>
            <div className="flex items-end justify-between gap-4 h-48 pt-4">
              {[60, 40, 80, 50, 90].map((h, idx) => (
                <div key={idx} style={{ height: `${h}%` }} className="flex-1 bg-crm-cardHover/40 rounded-t-md max-w-[45px] mx-auto" />
              ))}
            </div>
          </div>
          <div className="glass-panel h-80 rounded-xl p-6 bg-crm-cardHover/20 border border-crm-border/10 flex flex-col items-center justify-between">
            <div className="w-full text-left space-y-1">
              <div className="h-4 w-32 bg-crm-cardHover/50 rounded" />
              <div className="h-3 w-40 bg-crm-cardHover/30 rounded" />
            </div>
            <div className="h-36 w-36 rounded-full border-[14px] border-crm-cardHover/35 flex items-center justify-center my-4" />
            <div className="h-4 w-28 bg-crm-cardHover/30 rounded" />
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="glass-panel h-80 rounded-xl p-6 lg:col-span-2 bg-crm-cardHover/20 border border-crm-border/10 flex flex-col justify-between">
            ...
            <div className="h-44 border-b border-crm-border/20 flex items-center justify-center relative">
              <div className="absolute inset-0 bg-gradient-to-t from-transparent via-crm-cardHover/5 to-transparent h-[2px] w-full top-1/2" />
            </div>
          </div>
          <div className="glass-panel h-80 rounded-xl p-6 bg-crm-cardHover/20 border border-crm-border/10 space-y-4">
            <div className="h-4 w-28 bg-crm-cardHover/50 rounded" />
            <div className="space-y-3 pt-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex gap-3 pb-3 border-b border-crm-border/10 last:border-0 last:pb-0">
                  <div className="h-6 w-6 rounded-full bg-crm-cardHover/40 shrink-0" />
                  <div className="space-y-1.5 flex-1">
                    <div className="h-3.5 w-full bg-crm-cardHover/40 rounded" />
                    <div className="h-2.5 w-2/3 bg-crm-cardHover/30 rounded" />
                  </div>
                </div>
              ))}
            </div>
